...
const { isLoading, character } = storeToRefs(store)
      ...
      >
        ...
        <div class="flex items-center">
          ...
          <NuxtLink
            ...
            :key="episode"
            :to="`/episode/${episode}`"
            class="text-xl text-light-gray font-medium transition-colors duration-300 hover:text-orange-400 border mr-2 rounded grid place-items-center px-2 py-1 min-w-10"
          >
            {{ episode }}
          </NuxtLink>
        </div>
